...
class name_ban:
    def banner(self):
        ...
        print(c + "░ ▒▓ ░▒▓░░░ ▒░ ░ ▒░░  ▒ ░ ▒░▓  ░░▓   U")
        print(c + "  ░▒ ░ ▒░ ░ ░  ░   ▒  ▒   ░ ▒  ░ ▒ ░ J")
        print(c + "░SZ Tamil Technology ▒ S.Sivanujan ▒ A")
        print(c + "▒  ░  ▒   ░ ▒  ░   ▒  ▒     ▒    ░ ░ N")
        print(c + "    TRACKING THE END FACE OF URLs\n   ")
        print(c + " |||<<<verson 2.0>>>|||<<<source code copy from jtechode>>>|||<<<edit by sivanujan>>>||| ")
        print(c + " ||<<this tool help to safe from redirection to carm full web page from shorten link>>|| ")
...
It will show you the full redirection path of URLs, shortened links, or tiny URLs.'''
        ...
        print('\nCoded by: SIVANUJAN OF SZ TAMIL TECHNOLOGY')
        print('Subscribe YouTube : https://www.youtube.com/channel/UCdu3bGzEYlSEa4HMPw1AgNQ')
